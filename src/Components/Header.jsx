    ...
    return (
        <header className=" grid gap-10 md:grid-cols-2">
            <div className="grid md:my-8">
                ...
                <button className="max-w-sm flex items-center gap-2 bg-zinc-800 text-zinc-200 dark:text-zinc-700 p-3 my-3 rounded-lg hover:bg-zinc-800 dark:bg-zinc-200 dark:hover:bg-zinc-300" >
